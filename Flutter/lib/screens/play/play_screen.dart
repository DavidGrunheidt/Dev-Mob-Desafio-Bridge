  ...
  void playNext() {
    ...
    switch (repeat) {
      ...
      case RepeatMode.repeat:
        setState(() {
          currentIndex =
              nextIndex == tracks.length ? 0 : nextIndex;
        });
        audioPlayer.play(currentTrack.previewUrl, isLocal: false);
        break;
  ...
  Widget buildRepeatIcon() {
    switch (repeat) {
      case RepeatMode.none:
        ...
        break;
      case RepeatMode.repeat:
        return Icon(Icons.repeat, color: AudinoColors.blue);
        break;
      case RepeatMode.repeatOne:
        return Icon(Icons.repeat_one, color: AudinoColors.blue);
        break;
    }

    throw ArgumentError.value(repeat);
  }
}
